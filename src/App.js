...
function App() {
  ...
  const columns = [
    ...
    { title: "Age", field: "age", render: (rowData)=><div style={{background: rowData.age >= 18 ? "green" : "red"}}>{rowData.age}</div>/*, defaultGroupOrder:1*/, emptyValue: ()=><em>null</em>, searchable: false, export: false/*. defaultSort: "asc"*/},
